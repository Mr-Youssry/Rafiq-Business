...
| P4 | **Team Chat** | Real-time messaging (if not using Slack) | — (using Slack SaaS) | Slack, Teams, Discord | — | — | — | SaaS dependency |
...
| # | Capability | What it adds | Service | Replaces | Docker Image | RAM | Subdomain | Status |
|---|---|---|---|---|---|---|---|---|
| P8 | **Object Storage (S3)** | S3-compatible file storage for all services | Garage | AWS S3, MinIO, Backblaze B2 | `dxflrs/garage` | ~50 MB | internal API | 🆕 Explored |
| P9 | **File Sync & Sharing UI** | Dropbox-like UI, mobile sync, sharing | Nextcloud | Google Drive, Dropbox, OneDrive | `nextcloud:apache` | ~500 MB | files.office.rafiq-ai.com | 🆕 Explored |

### Finance & Operations

| # | Capability | What it adds | Service | Replaces | Docker Image | RAM | Subdomain | Status |
|---|---|---|---|---|---|---|---|---|
| P10 | **Accounting** | Invoices, expenses, reports, runway tracking | Bigcapital | QuickBooks, Xero, Wave | `bigcapitaltech/bigcapital` + MariaDB + MongoDB + Redis | ~750 MB | books.office.rafiq-ai.com | ✅ In v5 |
| P11 | **CRM** | Investor/school/partner pipeline tracking | Outline (structured docs) | HubSpot, Salesforce, Pipedrive | — (built into Outline) | — | wiki.office.rafiq-ai.com/crm | ✅ In v5 |

### Governance & Process

| # | Capability | What it adds | Service | Replaces | Docker Image | RAM | Subdomain | Status |
|---|---|---|---|---|---|---|---|---|
| P12 | **Holacracy Governance** | Roles, circles, tensions, proposals | GlassFrog API → later Outline-native | GlassFrog (SaaS) | — (API integration) | — | — | ✅ In v5 (Phase 4+6) |

### Observability & DevOps

| # | Capability | What it adds | Service | Replaces | Docker Image | RAM | Subdomain | Status |
|---|---|---|---|---|---|---|---|---|
| P13 | **LLM Observability** | Token usage, cost per task, latency, model performance | OpenLIT + ClickHouse + OTel Collector | Langfuse, Helicone, manual tracking | `ghcr.io/openlit/openlit` + `clickhouse/clickhouse-server` + `otel/opentelemetry-collector` | ~600 MB | obs.office.rafiq-ai.com | ✅ In v5 |
...
| **Additional total** | **+$24** | **+3,050 MB** |
| **Grand total (everything)** | **~$86–94/mo** | **~6,130 MB on main + Jitsi separate** |

*With all plugins on the main droplet (except Jitsi), RAM usage would be ~6.1 GB on the 8GB droplet — still fits with ~1.9 GB headroom. Jitsi needs its own $24/mo droplet due to video processing demands.*
